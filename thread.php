...
if(!empty($_POST)){
    ...
    if(empty($check)){
        //画像をアップロードする
        $commentImage = uploadImage($_FILES['commentimage'],'comment');
    ...
    <div class="thread_box">
        <div class="threadtop">
            ...
            <tr>
                ...
                <?php else: ?>
                <td>
                    <img src="image/user_image/<?=h($info['user_image'])?>" class="createUserImage">
                </td>
                <td>
        ...
        <?php if($info['thread_image'] != "noimage.png"): ?>
            <img src="image/thread_image/<?=h($info['thread_image'])?>" class="threadImage">
        <?php endif; ?>
        </div>
        <div class="comments">
                ...
                <div class="comment">
                    <table>
                        <tr>
                            ...
                            <?php else: ?>
                                <td><img src="image/user_image/<?=h($comment['user_image'])?>" class="createUserImage"></td>
                    ...
                    <?php if($comment['comment_image'] != 'noimage'): ?>
                        <img src="image/comment_image/<?=h($comment['comment_image'])?>" class="threadImage">
                    <?php endif; ?>
                    ...
                    <div class="reply_comment_box">
                            ...
                            <i class="fas fa-quote-left"></i>
                                <table>
                                    <tr>
                                        <td><img src="image/user_image/<?=h($reply_comment['user_image'])?>" class="createUserImage"></td>
                                ...
                                <?php if($reply_comment['comment_image'] != 'noimage'): ?>
                                    <img src="image/comment_image/<?=h($reply_comment['comment_image'])?>" class="reply_threadImage">
                                <?php endif; ?>
        ...
        <div class="categoryinfointhread">
            ...
            <Span>このスレッドが所属しているカテゴリー</span>
                <a href="category.php?id=<?=$info['category_id']?>&page=1">
                    <img src="image/category_image/<?=h($info['category_image'])?>">
                </a>
            </div>
