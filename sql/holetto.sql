...
category_name varchar(15) unique not null comment "カテゴリー名",
category_introduce varchar(50) not null comment "カテゴリーの紹介文",
category_image varchar(100) not null comment "カテゴリー画像",
...
first_comment varchar(120) not null comment "１コメ",
thread_image varchar(100) not null comment "スレッド画像",
...
comment varchar(120) not null comment "コメント内容",
thread_id int(20) not null comment "書き込んだスレッドのID",
user_id int(20) not null comment "書き込んだユーザーのID",
comment_image varchar(100) not null comment "コメント画像",
...
user_name varchar(15) unique not null comment "ユーザー名",
email varchar(50) unique not null comment "メールアドレス",
password varchar(255) not null comment "パスワード",
user_image varchar(100) not null comment "ユーザー画像",
insert_date date not null comment "登録日"
);
